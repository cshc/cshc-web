...
const MatchDetail = ({ ourTeam, oppTeam, data }) => (
  <Accordion accordionId="fixtureHistory">
    <AccordionCard
      cardId="FixtureHistoryCard"
      accordionId="fixtureHistory"
      title="Recent Fixture History"
      isOpen
    >
      {data.results ? (
        <div>
          <p>
            This table lists the most recent matches between {ourTeam.longName} and {oppTeam.name}.
            A full list of matches between {ourTeam.longName} and {oppTeam.club.name} can be found{' '}
