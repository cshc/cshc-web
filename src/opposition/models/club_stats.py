...
class ClubStats(models.Model):
    ...
    home_drawn = models.PositiveSmallIntegerField(
        "Home matches drawn", default=0)
    home_lost = models.PositiveSmallIntegerField(
        "Home matches lost", default=0)
    home_gf = models.PositiveSmallIntegerField(
        "Home matches - goals for", default=0)
    home_ga = models.PositiveSmallIntegerField(
        "Home matches - goals against", default=0)

    away_won = models.PositiveSmallIntegerField("Away matches won", default=0)
    away_drawn = models.PositiveSmallIntegerField(
        "Away matches drawn", default=0)
    away_lost = models.PositiveSmallIntegerField(
        "Away matches lost", default=0)
    away_gf = models.PositiveSmallIntegerField(
        "Away matches - goals for", default=0)
    away_ga = models.PositiveSmallIntegerField(
        "Away matches - goals against", default=0)
